        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Tanikoe-TV</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="row special-list">
                ...
                <center>  <EMBED SRC="images/tanikoetv.mp4" WIDTH="280" HEIGHT="300" AUTOPLAY="false">
          <h1><strong>Vlog </strong></h1></center></EMBED>
                </div>
</div>
